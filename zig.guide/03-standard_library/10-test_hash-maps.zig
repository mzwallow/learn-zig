...
// NOTE: 'std.StringHashMap' and 'std.AutoHashMap' are just wrappers for 'std.HashMap'.
// If these two do not fulfil your needs, using 'std.HashMap' directly gives you much more control.
//
// NOTE: If having your elements backed by an array is wanted behaviour,
// try 'std.ArrayHashMap' and its wrapper 'std.AutoArrayHashMap'.
